...
//  alert()     -   used with html or console-browser (document).      // error in node terminal, used in different syntax.


console.log(3+3); console.log("Hello")
console.log(10
    *
    5)          // Spaces are automatically avoided.
/*  
...
// ecma script does not write javascript but sets standard for js (lexical grammar).
...
console.log(typeof grade);     // Undefined - It is a type in JS.
